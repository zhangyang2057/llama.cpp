...
static void ggml_gemv_q4_0_8x8_q8_0(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT vx, const void * GGML_RESTRICT vy, int nr, int nc) {
    ...
    if (vlenb >= QK4_0) {
        ...
        for (int x = 0; x < nc / ncols_interleaved; x++) {
            ...
            vfloat32m1_t sumf = vfmv_v_f_f32m1(0.0, vl / 4);
            for (int l = 0; l < nb; l++) {
                ...
                const vint8m2_t lhs_0_8 =vreinterpret_v_i64m2_i8m2(vmv_v_x_i64m2(a0, vl / 4));
                const vint8m2_t lhs_1_8 =vreinterpret_v_i64m2_i8m2(vmv_v_x_i64m2(a1, vl / 4));
                const vint8m2_t lhs_2_8 =vreinterpret_v_i64m2_i8m2(vmv_v_x_i64m2(a2, vl / 4));
                const vint8m2_t lhs_3_8 =vreinterpret_v_i64m2_i8m2(vmv_v_x_i64m2(a3, vl / 4));

                const vint8m4_t rhs_raw_vec = vle8_v_i8m4((const int8_t *)b_ptr[l].qs, vl * 4);
                const vint8m4_t rhs_vec_lo = vsra_vx_i8m4(vsll_vx_i8m4(rhs_raw_vec, 4, vl * 4), 4, vl * 4);
                const vint8m4_t rhs_vec_hi = vsra_vx_i8m4(rhs_raw_vec, 4, vl * 4);
                const vint8m2_t rhs_vec_lo_0 = vget_v_i8m4_i8m2(rhs_vec_lo, 0);
                const vint8m2_t rhs_vec_lo_1 = vget_v_i8m4_i8m2(rhs_vec_lo, 1);
                const vint8m2_t rhs_vec_hi_0 = vget_v_i8m4_i8m2(rhs_vec_hi, 0);
                const vint8m2_t rhs_vec_hi_1 = vget_v_i8m4_i8m2(rhs_vec_hi, 1);

                const vint16m4_t sumi_lo_0 = vwmul_vv_i16m4(rhs_vec_lo_0, lhs_0_8, vl * 2);
                const vint16m4_t sumi_lo_1 = vwmacc_vv_i16m4(sumi_lo_0, rhs_vec_lo_1, lhs_1_8, vl * 2);
                const vint16m4_t sumi_hi_0 = vwmacc_vv_i16m4(sumi_lo_1, rhs_vec_hi_0, lhs_2_8, vl * 2);
                const vint16m4_t sumi_hi_m = vwmacc_vv_i16m4(sumi_hi_0, rhs_vec_hi_1, lhs_3_8, vl * 2);

                const vuint32m4_t sumi_i32 = vreinterpret_v_i32m4_u32m4(vreinterpret_v_i16m4_i32m4(sumi_hi_m));
                const vuint16m2_t sumi_h2_0 = vnsrl_wx_u16m2(sumi_i32, 0, vl);
                const vuint16m2_t sumi_h2_1 = vnsrl_wx_u16m2(sumi_i32, 16, vl);
                const vuint16m2_t sumi_h2 = vadd_vv_u16m2(sumi_h2_0, sumi_h2_1, vl);
                const vuint32m2_t sumi_h2_i32 = vreinterpret_v_u16m2_u32m2(sumi_h2);
                const vuint16m1_t sumi_h4_0 = vnsrl_wx_u16m1(sumi_h2_i32, 0, vl / 2);
                const vuint16m1_t sumi_h4_1 = vnsrl_wx_u16m1(sumi_h2_i32, 16, vl / 2);
                const vuint16m1_t sumi_h4 = vadd_vv_u16m1(sumi_h4_0, sumi_h4_1, vl / 2);
                const vuint32m1_t sumi_h4_i32 = vreinterpret_v_u16m1_u32m1(sumi_h4);
                const vint16mf2_t sumi_h8_0 = vreinterpret_v_u16mf2_i16mf2(vnsrl_wx_u16mf2(sumi_h4_i32, 0, vl / 4));
                const vint16mf2_t sumi_h8_1 = vreinterpret_v_u16mf2_i16mf2(vnsrl_wx_u16mf2(sumi_h4_i32, 16, vl / 4));
                const vint32m1_t sumi_h8 = vwadd_vv_i32m1(sumi_h8_0, sumi_h8_1, vl / 4);
                const vfloat32m1_t facc = vfcvt_f_x_v_f32m1(sumi_h8, vl / 4);
                ...
                const vfloat32m1_t b_scales_vec = vle32_v_f32m1(b_scales, vl / 4);
                const vfloat32m1_t tmp1 = vfmul_vf_f32m1(facc, a_scale, vl / 4);
                sumf = vfmacc_vv_f32m1(sumf, tmp1, b_scales_vec, vl / 4);
            }
            vse32_v_f32m1(s + x * ncols_interleaved, sumf, vl / 4);
        }
        return;
    }
...
static void ggml_gemm_q4_0_8x8_q8_0(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT vx, const void * GGML_RESTRICT vy, int nr, int nc) {
    ...
    if (vlenb >= QK4_0) {
        ...
        for (int y = 0; y < nr / 4; y++) {
            ...
            for (int x = 0; x < nc / ncols_interleaved; x++) {
                const block_q4_0x8 * b_ptr = (const block_q4_0x8 *) vx + (x * nb);
                vfloat32m1_t sumf0 = vfmv_v_f_f32m1(0.0, vl / 4);
                vfloat32m1_t sumf1 = vfmv_v_f_f32m1(0.0, vl / 4);
                vfloat32m1_t sumf2 = vfmv_v_f_f32m1(0.0, vl / 4);
                vfloat32m1_t sumf3 = vfmv_v_f_f32m1(0.0, vl / 4);
                for (int l = 0; l < nb; l++) {
                    const vint8m4_t rhs_raw_vec = vle8_v_i8m4((const int8_t *)b_ptr[l].qs, vl * 4);
                    const vint8m4_t rhs_vec_lo = vsra_vx_i8m4(vsll_vx_i8m4(rhs_raw_vec, 4, vl * 4), 4, vl * 4);
                    const vint8m4_t rhs_vec_hi = vsra_vx_i8m4(rhs_raw_vec, 4, vl * 4);
                    ...
                    {
                        const vint8m2_t lhs_0_8 =vreinterpret_v_i64m2_i8m2(vmv_v_x_i64m2(A0, vl / 4));
                        const vint8m2_t lhs_1_8 =vreinterpret_v_i64m2_i8m2(vmv_v_x_i64m2(A4, vl / 4));
                        const vint8m2_t lhs_2_8 =vreinterpret_v_i64m2_i8m2(vmv_v_x_i64m2(A8, vl / 4));
                        const vint8m2_t lhs_3_8 =vreinterpret_v_i64m2_i8m2(vmv_v_x_i64m2(Ac, vl / 4));
                        const vint16m4_t sumi_lo_0 = vwmul_vv_i16m4(rhs_vec_lo_0, lhs_0_8, vl * 2);
                        const vint16m4_t sumi_lo_1 = vwmacc_vv_i16m4(sumi_lo_0, rhs_vec_lo_1, lhs_1_8, vl * 2);
                        const vint16m4_t sumi_hi_0 = vwmacc_vv_i16m4(sumi_lo_1, rhs_vec_hi_0, lhs_2_8, vl * 2);
                        const vint16m4_t sumi_hi_m = vwmacc_vv_i16m4(sumi_hi_0, rhs_vec_hi_1, lhs_3_8, vl * 2);
                    ...
                    {
                        const vuint32m4_t sumi_i32 = vreinterpret_v_i32m4_u32m4(vreinterpret_v_i16m4_i32m4(sumi_l0));
                        const vuint16m2_t sumi_h2_0 = vnsrl_wx_u16m2(sumi_i32, 0, vl);
                        const vuint16m2_t sumi_h2_1 = vnsrl_wx_u16m2(sumi_i32, 16, vl);
                        const vuint16m2_t sumi_h2 = vadd_vv_u16m2(sumi_h2_0, sumi_h2_1, vl);
                        const vuint32m2_t sumi_h2_i32 = vreinterpret_v_u16m2_u32m2(sumi_h2);
                        ...
                        const vfloat32m1_t tmp1 = vfmul_vf_f32m1(facc, a_scales[0], vl / 4);
                        sumf0 = vfmacc_vv_f32m1(sumf0, tmp1, b_scales_vec, vl / 4);
                    }
                    ...
                    vint16m4_t sumi_l1;
                    {
                        const vint8m2_t lhs_0_8 =vreinterpret_v_i64m2_i8m2(vmv_v_x_i64m2(A1, vl / 4));
                        const vint8m2_t lhs_1_8 =vreinterpret_v_i64m2_i8m2(vmv_v_x_i64m2(A5, vl / 4));
                        const vint8m2_t lhs_2_8 =vreinterpret_v_i64m2_i8m2(vmv_v_x_i64m2(A9, vl / 4));
                        const vint8m2_t lhs_3_8 =vreinterpret_v_i64m2_i8m2(vmv_v_x_i64m2(Ad, vl / 4));
                        const vint16m4_t sumi_lo_0 = vwmul_vv_i16m4(rhs_vec_lo_0, lhs_0_8, vl * 2);
                        const vint16m4_t sumi_lo_1 = vwmacc_vv_i16m4(sumi_lo_0, rhs_vec_lo_1, lhs_1_8, vl * 2);
                        const vint16m4_t sumi_hi_0 = vwmacc_vv_i16m4(sumi_lo_1, rhs_vec_hi_0, lhs_2_8, vl * 2);
                        const vint16m4_t sumi_hi_m = vwmacc_vv_i16m4(sumi_hi_0, rhs_vec_hi_1, lhs_3_8, vl * 2);
                    ...
                    {
                        const vuint32m4_t sumi_i32 = vreinterpret_v_i32m4_u32m4(vreinterpret_v_i16m4_i32m4(sumi_l1));
                        const vuint16m2_t sumi_h2_0 = vnsrl_wx_u16m2(sumi_i32, 0, vl);
                        const vuint16m2_t sumi_h2_1 = vnsrl_wx_u16m2(sumi_i32, 16, vl);
                        const vuint16m2_t sumi_h2 = vadd_vv_u16m2(sumi_h2_0, sumi_h2_1, vl);
                        const vuint32m2_t sumi_h2_i32 = vreinterpret_v_u16m2_u32m2(sumi_h2);
                        ...
                        const vfloat32m1_t tmp1 = vfmul_vf_f32m1(facc, a_scales[1], vl / 4);
                        sumf1 = vfmacc_vv_f32m1(sumf1, tmp1, b_scales_vec, vl / 4);
                    }
                    ...
                    vint16m4_t sumi_l2;
                    {
                        const vint8m2_t lhs_0_8 =vreinterpret_v_i64m2_i8m2(vmv_v_x_i64m2(A2, vl / 4));
                        const vint8m2_t lhs_1_8 =vreinterpret_v_i64m2_i8m2(vmv_v_x_i64m2(A6, vl / 4));
                        const vint8m2_t lhs_2_8 =vreinterpret_v_i64m2_i8m2(vmv_v_x_i64m2(Aa, vl / 4));
                        const vint8m2_t lhs_3_8 =vreinterpret_v_i64m2_i8m2(vmv_v_x_i64m2(Ae, vl / 4));
                        const vint16m4_t sumi_lo_0 = vwmul_vv_i16m4(rhs_vec_lo_0, lhs_0_8, vl * 2);
                        const vint16m4_t sumi_lo_1 = vwmacc_vv_i16m4(sumi_lo_0, rhs_vec_lo_1, lhs_1_8, vl * 2);
                        const vint16m4_t sumi_hi_0 = vwmacc_vv_i16m4(sumi_lo_1, rhs_vec_hi_0, lhs_2_8, vl * 2);
                        const vint16m4_t sumi_hi_m = vwmacc_vv_i16m4(sumi_hi_0, rhs_vec_hi_1, lhs_3_8, vl * 2);
                    ...
                    {
                        const vuint32m4_t sumi_i32 = vreinterpret_v_i32m4_u32m4(vreinterpret_v_i16m4_i32m4(sumi_l2));
                        const vuint16m2_t sumi_h2_0 = vnsrl_wx_u16m2(sumi_i32, 0, vl);
                        const vuint16m2_t sumi_h2_1 = vnsrl_wx_u16m2(sumi_i32, 16, vl);
                        const vuint16m2_t sumi_h2 = vadd_vv_u16m2(sumi_h2_0, sumi_h2_1, vl);
                        const vuint32m2_t sumi_h2_i32 = vreinterpret_v_u16m2_u32m2(sumi_h2);
                        ...
                        const vfloat32m1_t tmp1 = vfmul_vf_f32m1(facc, a_scales[2], vl / 4);
                        sumf2 = vfmacc_vv_f32m1(sumf2, tmp1, b_scales_vec, vl / 4);
                    }
                    ...
                    vint16m4_t sumi_l3;
                    {
                        const vint8m2_t lhs_0_8 =vreinterpret_v_i64m2_i8m2(vmv_v_x_i64m2(A3, vl / 4));
                        const vint8m2_t lhs_1_8 =vreinterpret_v_i64m2_i8m2(vmv_v_x_i64m2(A7, vl / 4));
                        const vint8m2_t lhs_2_8 =vreinterpret_v_i64m2_i8m2(vmv_v_x_i64m2(Ab, vl / 4));
                        const vint8m2_t lhs_3_8 =vreinterpret_v_i64m2_i8m2(vmv_v_x_i64m2(Af, vl / 4));
                        const vint16m4_t sumi_lo_0 = vwmul_vv_i16m4(rhs_vec_lo_0, lhs_0_8, vl * 2);
                        const vint16m4_t sumi_lo_1 = vwmacc_vv_i16m4(sumi_lo_0, rhs_vec_lo_1, lhs_1_8, vl * 2);
                        const vint16m4_t sumi_hi_0 = vwmacc_vv_i16m4(sumi_lo_1, rhs_vec_hi_0, lhs_2_8, vl * 2);
                        const vint16m4_t sumi_hi_m = vwmacc_vv_i16m4(sumi_hi_0, rhs_vec_hi_1, lhs_3_8, vl * 2);
                    ...
                    {
                        const vuint32m4_t sumi_i32 = vreinterpret_v_i32m4_u32m4(vreinterpret_v_i16m4_i32m4(sumi_l3));
                        const vuint16m2_t sumi_h2_0 = vnsrl_wx_u16m2(sumi_i32, 0, vl);
                        const vuint16m2_t sumi_h2_1 = vnsrl_wx_u16m2(sumi_i32, 16, vl);
                        const vuint16m2_t sumi_h2 = vadd_vv_u16m2(sumi_h2_0, sumi_h2_1, vl);
                        const vuint32m2_t sumi_h2_i32 = vreinterpret_v_u16m2_u32m2(sumi_h2);
                        ...
                        const vfloat32m1_t tmp1 = vfmul_vf_f32m1(facc, a_scales[3], vl / 4);
                        sumf3 = vfmacc_vv_f32m1(sumf3, tmp1, b_scales_vec, vl / 4);
                    }
                }
                vse32_v_f32m1(&s[(y * 4 + 0) * bs + x * ncols_interleaved], sumf0, vl / 4);
                vse32_v_f32m1(&s[(y * 4 + 1) * bs + x * ncols_interleaved], sumf1, vl / 4);
                vse32_v_f32m1(&s[(y * 4 + 2) * bs + x * ncols_interleaved], sumf2, vl / 4);
                vse32_v_f32m1(&s[(y * 4 + 3) * bs + x * ncols_interleaved], sumf3, vl / 4);
            }
        }
